package com.example.lightweather.activity;
		...
		HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
			...
			public void onFinish(String response) {
				...
				if ("province".equals(type)) {
					result = Utility.handleProvincesResponse(weatherDataBase,
							response);
				} else if ("city".equals(type)) {
					result = Utility.handleCitiesResponse(weatherDataBase,
							response, selectedProvince.getId());
				} else if ("county".equals(type)) {
					result = Utility.handleCountiesResponse(weatherDataBase,
